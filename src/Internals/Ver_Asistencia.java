...
public class Ver_Asistencia extends javax.swing.JInternalFrame {
    ...
    public void BuscarLineaproducto(){
        ...
        cantTotal=Integer.parseInt(control.DevolverRegistroDto(control.Sql, 1));
            control.Sql=" SELECT * FROM vat_asistencia where fecha='"+control.Formato_Amd(jDateChooser1.getDate())+"' "+versentencia+
                    " and descripturno='"+cbTurno.getSelectedItem().toString()+"' "+
                    " and (nombres like '%"+txBuscar.getText()+"%' or dni like '%"+txBuscar.getText()+"%')";
        ...
        cantTotal=Integer.parseInt(control.DevolverRegistroDto(control.Sql, 1));
            ...
            control.Sql=" SELECT * FROM vat_asistencia where fecha='"+control.Formato_Amd(jDateChooser1.getDate())+"' and almu=0 "+versentencia+
                    " and descripturno='"+cbTurno.getSelectedItem().toString()+"' "+
                    " and (nombres like '%"+txBuscar.getText()+"%' or dni like '%"+txBuscar.getText()+"%')";
        }
    ...
    public Ver_Asistencia() {
     initComponents();setTitle("Ver Asistentes");
     this.setFrameIcon(new ImageIcon(this.getClass().getResource("/Imagenes/Vender.png")));
     tLineaproducto.setModel(modelo);modelo.setColumnIdentifiers(new String[]{"Id", "Tipo Comensal", "Facultad", "Dni", "Nombres", "Horario de Registro", "Fecha", "Turno"});
     ...
     tLineaproducto.getColumnModel().getColumn(4).setPreferredWidth(130);
    ...
    private void initComponents() {
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Lista de Asistentes Hoy", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Times New Roman", 1, 12), new java.awt.Color(0, 0, 102))); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
      ...
      if(cadena.equals("TODOS")){
       cadena="";   
        ...
        impri.Impresion5Parametros("tipo","Turno:   "+cbTurno.getSelectedItem().toString(),"fec", control.Formato_Amd(jDateChooser1.getDate()), "agcad", cbTurno.getSelectedItem().toString(), "cant", cnatidaddeasis,"fecf",cadena, "Ver_Asistentes");
