...
import javax.swing.*;
import Clases.*;
public class Casos_Especiales extends javax.swing.JInternalFrame {
    /*************************Atributos**********************/ 
    ...
    public void CrearBanco(){   
     if(txDireccion.getText().trim().length()==0){
      ...
      control.Sql="select * from casoespecial where descricasoesp='"+
      txBanco.getText()+"'";   
      if(control.Verificandoconsulta(control.Sql)){
       JOptionPane.showMessageDialog(rootPane,"El Caso es correcto");          
      }
      else{       
       control.Sql="insert into casoespecial  values(null,'"+control.PriLtrasMayuscula(txBanco.getText())+
    ...
    public void ModificarBanco(){
     if(txDireccion.getText().length()>0){
      control.Sql="select * from casoespecial where descricasoesp='"+txBanco.getText()+
      "' and codcasoesp='"+txDireccion.getText()+"' and idcasoespecial<>'"+idBnc+"'";        
      if(!control.Verificarconsulta(control.Sql)){
       control.Sql="update casoespecial set descricasoesp='"+txBanco.getText()+"',"+
       "codcasoesp='"+txDireccion.getText()+"' where idcasoespecial='"+idBnc+"'";        
       ...
       JOptionPane.showMessageDialog(rootPane,"Existe repeticion el nombre del Caso Especial");   
      }         
     } 
     else{
      JOptionPane.showMessageDialog(rootPane,"Faltan datos");   
...
//      if(!control.Verificandoconsulta(control.Sql)){
       if(JOptionPane.showConfirmDialog(rootPane,"Seguro deseas eliminar","Confirmar",0)==0){
        control.Sql="delete from casoespecial where idcasoespecial='"+idBnc+"'";    
...
//      }
    ...
    public void BuscarBanco(){
     control.Sql="select * from casoespecial where (descricasoesp like '%"+txBuscar.getText()+"%' or codcasoesp like'%"+txBuscar.getText()+"%')";
     control.LlenarJTabla(modelo,control.Sql,3);    
    }
    public void ValidardatosBancos(){
          
    }
    public Casos_Especiales() {
     initComponents();setTitle("Datos de los Casos Especiales");
     this.setFrameIcon(new ImageIcon(this.getClass().getResource("/Imagenes/Vender.png")));
     tBancos.setModel(modelo);modelo.setColumnIdentifiers(new String[] {"Id","Caso Especial","Codigo"});
...
//     tBancos.getColumnModel().getColumn(0).setPreferredWidth(0);
    ...
    private void initComponents() {
        ...
        getContentPane().add(txBanco, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 80, 430, -1));
        getContentPane().add(txDireccion, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 120, 430, -1));
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Datos del Caso Especial", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Times New Roman", 1, 12), new java.awt.Color(0, 51, 102))); // NOI18N
        jPanel2.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        jLabel1.setFont(new java.awt.Font("Times New Roman", 1, 13)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(0, 51, 153));
        jLabel1.setText("Codigo Caso");
        ...
        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Lista de Casos Especiales", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Times New Roman", 1, 12), new java.awt.Color(0, 0, 153))); // NOI18N
