...
public class Ver_Estadisticas_De_Comensales extends javax.swing.JInternalFrame {
...
//     }
    ...
    public Ver_Estadisticas_De_Comensales() {
     initComponents();setTitle("Ver Reporte de Faltas");
     ...
     tbFaltas.setModel(modelo1);modelo1.setColumnIdentifiers(new String[] {"Id","Fecha","Turno"});
     txBuscar.grabFocus();
     ...
     cbTurno.addItem("TODOS");
     cbTurno.setSelectedItem("TODOS");
...
//        tbFaltas.setDefaultRenderer(Object.class, ft);
    ...
    private void initComponents() {
        ...
        jPanel2.add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(640, 140, 480, 360));
        ...
        jPanel2.add(cbTurno, new org.netbeans.lib.awtextra.AbsoluteConstraints(760, 110, 340, -1));

        jLabel6.setFont(new java.awt.Font("Times New Roman", 1, 13)); // NOI18N
        jLabel6.setForeground(new java.awt.Color(0, 51, 153));
        jLabel6.setText("Turno");
        jPanel2.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(710, 110, 40, 20));
        ...
        lbDni.setText(" ");
        jPanel2.add(lbDni, new org.netbeans.lib.awtextra.AbsoluteConstraints(770, 50, 330, 20));

        jLabel11.setFont(new java.awt.Font("Times New Roman", 1, 13)); // NOI18N
        jLabel11.setForeground(new java.awt.Color(0, 51, 153));
        jLabel11.setText("Dni");
        jPanel2.add(jLabel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(720, 50, 30, 20));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
      ...
      if(cadena.equals("TODOS")){
       cadena="";   
        ...
        imprime.Impresion4Parametros("dni",dni,"feci", control.Formato_Amd(fcInicio.getDate()), "fecf",control.Formato_Amd(fcFinal.getDate()) , "tipo", cadena, "Ver_Reporte_Alumno");
