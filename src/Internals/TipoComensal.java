...
public class TipoComensal extends javax.swing.JInternalFrame {
    ...
    public void CrearLineaproducto(){   
     if(txLineas.getText().trim().length()==0){
      ...
      control.Sql="select * from tipocomensal where descritipcom='"+txLineas.getText()+"'";   
      if(control.Verificandoconsulta(control.Sql)){
       JOptionPane.showMessageDialog(rootPane,"El Tipo de Comensal está repetida");          
      }
      else{       
         control.Sql=String.format("insert into tipocomensal values(null,'%s')",control.PriLtrasMayuscula(txLineas.getText()));
    ...
    public void ModificarLineaproducto(){
     if(txLineas.getText().length()>0){
      ...
      control.Sql="select * from tipocomensal where descritipcom='"+txLineas.getText()+
      "' and idtipocomensal<>'"+idLinProd+"'";        
      if(!control.Verificarconsulta(control.Sql)){
          control.Sql=String.format("update tipocomensal set descritipcom='%s' where idtipocomensal='%s';",txLineas.getText(), idLinProd);
       ...
       JOptionPane.showMessageDialog(rootPane,"Existe repeticion en el Tipo de Comensal");   
      }         
     } 
     else{
      JOptionPane.showMessageDialog(rootPane,"Faltan datos");   
...
//      if(!control.Verificandoconsulta(control.Sql)){
       if(JOptionPane.showConfirmDialog(rootPane,"Seguro deseas eliminar","Confirmar",0)==0){
        control.Sql="delete from tipocomensal where idtipocomensal='"+idLinProd+"'";    
...
//      }
    ...
    public void BuscarLineaproducto(){
     control.Sql="select * from tipocomensal where descritipcom like '%"+txBuscar.getText()+"%'";
    ...
    public TipoComensal() {
     initComponents();setTitle("Tipo Comensal");
     this.setFrameIcon(new ImageIcon(this.getClass().getResource("/Imagenes/Vender.png")));
     tLineaproducto.setModel(modelo);modelo.setColumnIdentifiers(new String[] {"Código","Tipo Comensal"});
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Tipo de Comensal");
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Lsita de Tipos de Comensal", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Times New Roman", 1, 12), new java.awt.Color(0, 0, 102))); // NOI18N
        ...
        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Datos del Tipo de Comensal", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Times New Roman", 1, 12), new java.awt.Color(0, 0, 102))); // NOI18N
